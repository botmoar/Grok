  ...
  <section class="am-band">
    <div class="am-wrap am-about-grid">
      ...
      <div class="am-about-copy">
        ...
        <p>אני עמיחי מרקס. יותר מעשרים שנה במערכת הפיננסית בארץ ובחו״ל, הסמכה לייעוץ כלכלת המשפחה, רישיון לייעוץ פנסיוני, וגם הכשרה כמאמן וכמגשר. את 2008 ראיתי מבפנים: שוק שנפל, ואנשים שאיבדו חסכונות בלי להבין למה. מאז הליווי של משפחות הוא העבודה עצמה, לא תוספת.</p>
  ...
  <section class="am-band">
    <div class="am-wrap am-process">
      <div>
        ...
        <p>שלוש פגישות, ואחר כך ליווי. לא קורס אחיד. התיאור המלא נמצא בעמודי הפגישות.</p>
      </div>
      <ol>
        <li>
